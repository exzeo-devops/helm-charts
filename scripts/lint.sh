...
docker run -it --network host --workdir=/data --volume $SRCROOT:/data quay.io/helmpack/chart-testing:v3.7.1 ct lint --config .github/configs/ct-lint.yaml --lint-conf .github/configs/lintconf.yaml --debug